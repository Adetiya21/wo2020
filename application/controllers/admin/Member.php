...
class Member extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('m_member','Model');
	}
	...
	public function update()
	{
        ...
        // jika username tidak di ganti
			if ($row->nama == $this->input->post('nama')) {
				...
				// {
				// 	if(file_exists('assets/assets/img/member/'.$this->input->post('remove_photo')) && $this->input->post('remove_photo'))
				// 		unlink('assets/assets/img/member/'.$this->input->post('remove_photo'));
				// 	$data['gambar'] = '';
				// }
    ...
    //         		//hapus gambar lama di folder
				...
				// 	if(file_exists('assets/assets/img/member/'.$row_cek->gambar) && $row_cek->gambar)
				// 		unlink('assets/assets/img/member/'.$row_cek->gambar);
				// 	$data['gambar'] = $upload;
				// }
	...
	{
		$config['upload_path']   = 'assets/assets/img/member/';
