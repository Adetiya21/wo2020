			...
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						...
						<span>Berikut data ulasan produk : <?= $produk->nama ?></span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>vendor/ulasan/json/<?= $pr ?>", "type": "POST"},
        columns: [
        {
            "data": "id_ulasan",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("vendor/ulasan/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
