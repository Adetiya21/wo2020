...
<script>
    $(document).ready(function() {
      ...
      $('.pesanan-produk').addClass('active');
  	});
			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('vendor/pesanan') ?>">Pesanan</a>
						</li>
						<li class="breadcrumb-item">
							<a href="<?= site_url('vendor/pesanan/detail/'.$invoice->invoice) ?>">Detail</a>
						</li>
					</ul>
				</div>
			</div>
			            ...
			            <div class="col-md-12">
							<div class="card">
								<div class="card-header" align="center">
									<h4 style="font-weight: bold;margin-top: 15px;">PESANAN INVOICE : <?= $invoice->invoice ?></h4>
									<hr style="height: 1px; background: #333;margin-bottom:-10px">
								</div>
													...
													<tr>
														<td>
															<a href="<?= site_url('produk/detail/'.$key->slug) ?>">
																<img width="80px" height="80px" src="<?php echo base_url(); ?>assets/assets/img/produk/<?= $key->gambar_produk ?>" class="img-thumbnail">
															</a>
														</td>
									...
									<div class="dt-responsive table-responsive">
										<table class="table table-sm">
											...
											<thead>
				                                ...
				                                <tr>
				                                    <th colspan="2">
				                                    	<?php if ($invoice->gambar==null) {
						                                	echo '<i>(Bukti Pembayaran Belum Ada)</i>';
						                                } else{ ?>
				                                    	<img src="<?= base_url('assets/front_end/inv/') ?><?= $invoice->gambar ?>" alt="Bukti Transfer" width="280px">
				                                    	</th>
					                                    <?php } ?>
				                                </tr>
					                            <?php } ?>
