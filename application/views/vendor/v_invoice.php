...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
    	...
    	processing: true,
    	serverSide: true,
    	ajax: {"url": "<?= base_url() ?>vendor/pesanan/json", "type": "POST"},
    	columns: [
    	{
    		"data": "id",
    		"orderable": false
    	...
    	{"data": "payment",
    		render: function(data) { 
    			if(data=='Transfer Bank'){
    				return '<span class="label label-inverse-info">'+data+'</span>'	
    			} else {
    				return '<span class="label label-inverse-warning">'+data+'</span>'	
    			}
    		},
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("vendor/pesanan/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
	...
	function edit(id)
	{
		...
		$.ajax({
			url : '<?php echo site_url("vendor/pesanan/edit/'+id+'") ?>',
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{
	...
	function save()
	{
		...
		var url;    
		url = "<?php echo site_url('vendor/pesanan/update')?>";
