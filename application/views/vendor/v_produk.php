		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>Produk</h5>
						<span>Berikut daftar produk.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				...
				<div class="page-body">
					<div class="card">
						...
						<div style="position: absolute;right: 20px; top: 15px;">
							<a class="btn btn-primary btn-round" href="<?= site_url('vendor/produk/tambah')  ?>"><span class="fa fa-edit"></span> Input Data</a>	
						</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>vendor/produk/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("vendor/produk/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
