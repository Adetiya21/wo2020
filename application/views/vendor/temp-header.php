							...
							<li class="user-profile header-notification">
								<div class="dropdown-primary dropdown">
									...
									<ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
										<li>
											Hello, Vendor <?php echo $this->session->userdata('nama')?>
											<hr style="margin-bottom: -10px">
										</li>
										<li>
											<a href="<?= site_url('vendor/home/profil/') ?>">
												<i class="feather icon-user"></i> Profil
											</a>
										</li>
										<li>
											<a href="<?= site_url('vendor/welcome/logout') ?>">
						...
						<div class="nav-list">
							<div class="pcoded-inner-navbar main-menu">
								...
								<ul class="pcoded-item pcoded-left-item">
									<li class="home">
										<a href="<?= site_url('vendor/home') ?>" class="waves-effect waves-dark">
								...
								<ul class="pcoded-item pcoded-left-item">	
									<li class="profil">
										<a href="<?= site_url('vendor/home/profil/') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon">
												<i class="feather icon-users"></i>
											</span>
											<span class="pcoded-mtext">Profil Vendor</span>
										</a>
									</li>

									<li class="kategori">
										<a href="<?= site_url('vendor/kategori') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon">
									...
									<li class="produk pcoded-hasmenu">
										...
										<ul class="pcoded-submenu">
											<li class="data-produk">
												<a href="<?= site_url('vendor/produk') ?>" class="waves-effect waves-dark">
													<span class="pcoded-mtext"></span> Daftar Produk
												</a>
											</li>
											<li class="input-paket">
												<a href="<?= site_url('vendor/produk/tambah') ?>" class="waves-effect waves-dark">
													<span class="pcoded-mtext"></span> Input Produk 
												</a>
											</li>
										</ul>
									</li>

									<li class="pesanan pcoded-hasmenu">
										<a href="javascript:void(0)" class="waves-effect waves-dark">
											<span class="pcoded-micon">
										...
										<ul class="pcoded-submenu">
											...
											<li class="pesanan-saya">
												<a href="<?= site_url('vendor/pesanan_produk/saya') ?>" class="waves-effect waves-dark">
													<span class="pcoded-mtext"></span> Pesanan Produk Saya 
												</a>
											</li>
										</ul>
									</li>
