        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Vendor</h5>
                        <span>Berikut daftar Vendor.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/vendor/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
        ...
        {"data": "status",
            render: function(data) { 
                  return '<label class="label label-lg label-primary" style="width:100%; text-align:center">'+data+'</label>'
              },
    ...
    function tambah()
    {
        ...
        $('.modal-title').text('Tambah vendor Produk'); // Set Title to Bootstrap modal title
    }
