      ...
      <div class="col-lg-4">
        <div class="page-header-breadcrumb">
          <ul class=" breadcrumb breadcrumb-title">
            ...
            <li class="breadcrumb-item">
              <a href="<?= site_url('admin/produk_gambar/i/'.$produk->id) ?>"><?= $produk->nama ?></a>
            </li>
          </ul>
        </div>
      </div>
              ...
              <div class="card">
                ...
                <div class="card-block">
                  <div class="dt-responsive">
                    ...
                    <form action="<?= site_url('admin/produk_gambar/proses') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">            
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: {"url": "<?= base_url() ?>admin/produk_gambar/json/<?= $produk->id ?>", "type": "POST"},
      columns: [
      {
        "data": "id",
        "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/produk_gambar/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
