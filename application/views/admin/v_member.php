        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Member</h5>
                        <span>Berikut daftar Member.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?= site_url('admin/member') ?>">Member</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/member/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
        ...
        //           return '<img class="img-thumbnail" width="100%" height="100" src="<?= base_url('assets/assets/img/member/') ?>'+data+'">' 
        //         } else {
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/member/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    $('.help-block').empty(); // clear error string
        $.ajax({
            url : '<?php echo site_url("admin/member/edit/'+id+'") ?>',
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                //     $('#photo-preview div').html('<img src="<?= base_url('assets/assets/img/member/') ?>'+data.gambar+'" width="0" height"0" class="img-responsive">'); // show photo
    ...
    $('.help-block').empty(); // clear error string
        $.ajax({
            ...
            success: function(data)
            {
                ...
                // {
                //     $('#label-photo').text('Change Photo'); // label photo upload
                //     $('#photo-preview div').html('<img src="<?= base_url('assets/assets/img/member/') ?>'+data.gambar+'" width="335px" height="200px" class="img-responsive">'); // show photo
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/member/tambah')?>";
    } else {
        url = "<?php echo site_url('admin/member/update')?>";
    }
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Member" name="nama" required/>
