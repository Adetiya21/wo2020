			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/produk') ?>">Edit Produk</a>
						</li>
					</ul>
				</div>
			</div>
						...
						<div class="card-block">
							<div id="wizard">
								<section>
									...
									<?= form_open('admin/produk/proses_edit',$arb); ?>
				                    ...
				                    <div class="form-group row">
				                      ...
				                      <div class="col-sm-10">
				                        <select class="form-control select2" name="id_vendor" style="width: 100%;">
							              <option>Pilih Vendor</option>
							              <?php foreach ($ven->result() as $key) {
							              	if ($produk->id_vendor==$key->id) { ?>
							              		<option value="<?= $key->id ?>" selected><?= $key->nama ?></option>
							              	<?php } else {
							                ?>
							                <option value="<?= $key->id ?>"><?= $key->nama ?></option>
				                    ...
				                    <div class="form-group row">
				                      ...
				                      <div class="col-sm-10">
				                        <input type="number" class="form-control" placeholder="Jumlah" name="kp" value="<?= $produk->kuantitas_penjualan ?>">
				                      </div>
				                    </div>
				                    <div class="form-group row">
				                      <label class="col-sm-2 col-form-label">Deskripsi</label>
				                      <div class="col-sm-10">
				                        <textarea class="form-control" name="deskripsi" rows="5" id="editor1"><?= $produk->deskripsi ?>
				                        </textarea> 
				                      </div>
				                    </div>
				                    <div class="form-group row">
				                      ...
				                      <div class="col-sm-10">
				                        <input id="uploadImage" class="form-control" type="file" name="gambar" onchange="PreviewImage();" value="<?= $produk->gambar ?>" />
				                        <div class="form-group" id="photo-preview"></div>
			                                <p class="help-block">Max. 2MB</p>
			                                <img id="uploadPreview" style="width:350px; height:210px; border-radius: 10px; box-shadow: 0px 0px 3px 0px;" src="<?= base_url('assets/assets/img/produk/') ?><?= $produk->gambar ?>" />
				                      </div>
				                    </div>
				                    <hr>
